...
/*                                                +#+#+#+#+#+   +#+           */
/*   Created: 2024/02/06 20:22:11 by brayan            #+#    #+#             */
/*   Updated: 2024/02/19 18:04:11 by bsaiago-         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
/*
* PRE: -
* POST: Asigna un tenedor a un philo dependiendo de si su id es 
*       par o impar devolviendo el estado De la operacion
...
/*
* PRE: -
* POST: Chequea la inicializacion de los philos, cargando sus campos y 
...
/*
* PRE: -
* POST: Chequea la inicialización de los forks, cargando sus campos 
...
static int	wrapper_init_program(t_program *program)
{
	...
	if (init_forks(&program->forks, program->total_philos) != OK)
		return (ERROR);
	if (init_philos(&program->philos, program->total_philos \
	, program->forks, program) != OK)
