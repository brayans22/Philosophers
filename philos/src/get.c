...
/*                                                +#+#+#+#+#+   +#+           */
/*   Created: 2024/02/06 20:19:25 by brayan            #+#    #+#             */
/*   Updated: 2024/02/06 20:58:30 by brayan           ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
/*
* PRE: -
* POST: Alloca un bloque de memoria con malloc y lo llena de '\0' 
*       si todo sale correctamente, En caso de error, devuelve NULL 
*       y muestra un mensaje por terminal indicando un error.
*/
...
/*
* PRE: -
* POST: Obtenemos el valor del total de los philos que estan llenos, 
*		evitando el data race.
*/
